...
class SelectionPage(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.controller.withdraw('zoomed')
        ...
        my_canvas.create_text(390, 230, text="Welcome !", font=("Helvetica", 26, "bold"))
        my_canvas.create_text(390, 335, text="Please enter a PIN of your choice with maximum 9 digits", font=("Helvetica", 12, "bold"))
        my_canvas.create_text(390, 360, text="Click on the input box to hide your PIN", font=("Helvetica", 14))
        my_canvas.create_text(390, 390, text="Please use the KEY PAD to enter PIN", font=("Helvetica", 18))
        pw=StringVar()
        pin_select= Entry(self, textvariable=pw, font=("Helvetica", 24, "bold"), width=6, bd=5)
        ...
        b1= Button(self, image=n1i, borderwidth=0, command=lambda: button_click(1))
        l1= Label(self, text='')
        ...
        b2= Button(self, image=n2i, borderwidth=0, command=lambda: button_click(2))
        l2= Label(self, text='')
        ...
        b3= Button(self, image=n3i, borderwidth=0, command=lambda: button_click(3))
        l3= Label(self, text='')
        ...
        b4= Button(self, image=n4i, borderwidth=0, command=lambda: button_click(4))
        l4= Label(self, text='')
        ...
        b5= Button(self, image=n5i, borderwidth=0, command=lambda: button_click(5))
        l5= Label(self, text='')
        ...
        b6= Button(self, image=n6i, borderwidth=0, command=lambda: button_click(6))
        l6= Label(self, text='')
        ...
        b7= Button(self, image=n7i, borderwidth=0, command=lambda: button_click(7))
        l7= Label(self, text='')
        ...
        b8= Button(self, image=n8i, borderwidth=0, command=lambda: button_click(8))
        l8= Label(self, text='')
        ...
        b9= Button(self, image=n9i, borderwidth=0, command=lambda: button_click(9))
        l9= Label(self, text='')
        ...
        b0= Button(self, image=n0i, borderwidth=0, command=lambda: button_click(0))
        l0= Label(self, text='')
...
class StartPage(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        my_canvas.create_text(390, 230, text="Please enter your PIN", font=("Helvetica", 24, "bold"))
        my_canvas.create_text(390, 200, text="*Enter the PIN you chose in the welcome page*", font=("Helvetica", 14, "bold"))
        my_canvas.create_text(390, 380, text="Click on the input box to hide your PIN", font=("Helvetica", 14))
        my_canvas.create_text(390, 410, text="Please use the KEY PAD to enter PIN", font=("Helvetica", 14))
...
class WithdrawPage(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        choose_amount_label = Label(self,
                                                           ...
                                                           fg='white',
                                                           bg='#FF7F50')
        canvas.create_window(475,180, width=400, height=40, window=choose_amount_label)
        ...
        def withdraw(amount):
            ...
            if amount<current_balance:
                choose_amount_label = Label(self,
                                                           ...
                                                           fg='white',
                                                           bg='#FF7F50')
                canvas.create_window(475,180, width=440, height=40, window=choose_amount_label)
                current_balance -= amount
                controller.shared_data['Balance'].set(current_balance)
                controller.show_frame('MenuPage')
            else:
                choose_amount_label = Label(self,
                                                           text='Your demand exceeds your current balance!',
